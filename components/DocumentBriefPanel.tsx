    ...
    <section className="space-y-4">
      <div className="rounded-lg border border-stone-300 bg-white p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link className="rounded-md bg-navy px-3 py-2 text-sm text-white" href="/assistant">
            Ask this document
          </Link>
          <Link className="rounded-md border border-stone-400 px-3 py-2 text-sm" href="/compare">
            Compare version
          </Link>
          <Link className="rounded-md border border-stone-400 px-3 py-2 text-sm" href="/checklist">
            Prepare for lawyer
          </Link>
        </div>
      </div>
        ...
        <ul className="mt-3 space-y-2">
          {findings.map((finding) => (
            <li key={finding.id}>
              <button
                type="button"
                className="w-full rounded-md border border-stone-300 px-3 py-2 text-left hover:bg-stone-50"
